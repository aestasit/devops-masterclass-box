...
@rem call gradlew -b test.gradle -Pinfra=aws createServer || goto :error
@rem call gradlew -b test.gradle -Pinfra=aws uploadTests runTests || goto :error
@rem call gradlew -b test.gradle -Pinfra=aws destroyServer || goto :error
